...
import com.example.homework013.adapter.LaunchImproveAdapter;

public class   LaunchImproveActivity extends AppCompatActivity {
    // 声明引导页面的图片数组
    private int[] lanuchImageArray = {R.drawable.hasu,
            R.drawable.samsung, R.drawable.laika, R.drawable.xiaomi};
